...
1.	python-3.12.3-amd64
2.	pycharm-community-2024.1
3.	dbeaver-ce-latest-x86_64 (Alternative to Webyog_SQLyog_6.56_Enterprise)
4.	xampp-windows-x64-8.2.12-0-VS16-installer
5.	Visual C++ Redistributable 2022 (arm64)
6.	Visual C++ Redistributable 2022 (x64)
